        ...
        case "add":
            ...
            switch (target_type_input.options[typeIndex].value) {
                ...
                case "hyperbola":
                    ...
                    var str = "DrawHyperbola({0},{1})".format("basic", x_input.value)
                    code_input.value += str
                    break
                default:
                    break
...
function justTest() {
    addWorldLine("test", 0, 0.3, "red")
    //addAxis("new", 100, 0, spa2d)
    //ChangeViewTo("test")
    //centralizeWorldline("test")
    Draw()
    DrawHyperbola("basic",150, 0)
    DrawLight("basic")
    //DrawLight("new")
}
